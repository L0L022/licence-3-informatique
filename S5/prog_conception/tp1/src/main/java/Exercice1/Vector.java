...
/**
 * La classe Vector implémente un tableau d'entiers de taille dynamique. Les
...
public class Vector {
	 ...
	 * alors les nouveaux éléments sont initialisés à zéro.
	 *
	...
	/**
	 * Place l'élément element à l'indice index dans le vecteur. Ne fait rien si
	...
	/**
	 * Renvoie l'élément stocké à l'indice index donné. Si index n'est pas valide
	 * alors c'est zéro qui est retourné.
	 *
	 * @param index L'indice de l'emplacement de l'élément
